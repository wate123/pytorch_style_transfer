...
class Options():
    def __init__(self):
        ...
        optim_arg.add_argument("--iters", type=int, nargs='?', const=1, default=300,
                                help="number of training iterations, default is 300")
        ...
        optim_arg.add_argument("--content-size", type=int, nargs='?', const=1, default=512,
        ...
        optim_arg.add_argument("--cuda", type=int, default=1,
                                help="set it to 1 for running on GPU, 0 for CPU")
        optim_arg.add_argument("--content-weight", type=float, nargs='?', const=1, default=10.0,
                                help="weight for content-loss, default is 1.0")
